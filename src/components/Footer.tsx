      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-xl font-bold mb-4 text-gradient">Entrepreneur Framework</h3>
            <p className="text-gray-400 mb-6 max-w-md">
              The proven methodology for entrepreneurial success—Nail It, Scale It, Sail It—based on Prof. Loredana's groundbreaking research.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Nail It</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Scale It</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Sail It</a></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} Entrepreneur Framework. All rights reserved.
          </p>
